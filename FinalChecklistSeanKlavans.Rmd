...
Lines 38 through 46, function is implemented on line 62

(G) .Rmd Line number(s) for use of loops and/or control flow: 

Lines 39 through 45 (if-else statement used in whichConf function)
...
[Repository Link](https://github.com/seank22/Stat184FinalProject)

https://github.com/seank22/Stat184FinalProject
